...
REASONER_RUNTIME_SYSTEM = """You are the Reasoner sub-agent for legal reasoning multiple-choice questions.

Given a legal question (and choices, optional context), produce a short neutral scaffold focusing on the governing rule, its doctrinal elements, and how the facts map onto them. Output ONLY a JSON object with this schema:
{
  "case_facts": [str],
  "task_type": str,
