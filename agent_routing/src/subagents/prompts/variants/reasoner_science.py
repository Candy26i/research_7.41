...
The Reasoner's job is to convert a graduate-level science multiple-choice question in physics, chemistry, or biology into a SHORT STRUCTURED SCAFFOLD. Another model, the manager, will use the scaffold to decide. The Reasoner itself MUST NEVER state or imply the final answer.
...
Return ONLY a valid JSON object with this schema:
{
  ...
  "task_type": "<short category such as calculation, mechanism, quantitative_analysis, conceptual_reasoning, formula_application, experimental_design, comparison, cause_effect, or other>",
  "decision_factors": ["<neutral factor the manager should evaluate>"],
  "knowledge_slots": ["<compact scientific principle, formula, or domain fact (physics/chemistry/biology) needed to evaluate the question>"],
